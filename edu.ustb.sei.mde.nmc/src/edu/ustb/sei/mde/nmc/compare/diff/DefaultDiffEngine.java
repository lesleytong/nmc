...
import static edu.ustb.sei.mde.nmc.compare.util.ReferenceUtil.getAsList;
import static edu.ustb.sei.mde.nmc.compare.util.ReferenceUtil.safeEGet;
...
import edu.ustb.sei.mde.nmc.compare.IDiffProcessor;
import edu.ustb.sei.mde.nmc.compare.IEqualityHelper;
import edu.ustb.sei.mde.nmc.compare.Match;
import edu.ustb.sei.mde.nmc.compare.util.ComparisonUtil;
...
public class DefaultDiffEngine{
	...
	protected void checkForDifferences(Match match) {
		...
		internalCheckForDifferences(match, ffa.getFeatureFilter());
	}
